...
\begin{proof}
  ...
  \colorBYB$(x,n,k,x+n))$であるから$c=\mix(\colorBYB(x,n,k,x),\colorBYB(x,n,k,x+n))$．
...
最後に補題\ref{lem:even}，\ref{lem:shortodd}，\ref{lem:longodd}を用いて
