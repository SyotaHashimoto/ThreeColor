...
\def\Masu{v}
\newcommand\V[2]{v^{#1}_{#2}}
\newcommand\C[2]{c^{#1}_{#2}}
\newcommand\xx{{\tt x}}
\newcommand\yy{{\tt y}}
\newcommand\nn{{\tt n}}
\newcommand\topcolor{\textit{topcoloring}}
...
\def\yel{\textit{yel}}
\def\mix{\textit{mix}}
\def\coloringYB{\textit{coloringYB}}
\def\coloringYBBY{\textit{coloringYBBY}}
\def\coloringBYB{\textit{coloringBYB}}
\def\cposF{\textit{cposF}}
\def\cposYB{\textit{cposYB}}
\def\cposBYB{\textit{cposBYB}}
\def\cposYBBY{\textit{cposYBBY}}
\def\lift{\textit{liftcoloring}}
\def\cpos{\textit{cpos}}
\def\Cpos{\textit{Cpos}}
\def\T{\textit{Triangle}}
