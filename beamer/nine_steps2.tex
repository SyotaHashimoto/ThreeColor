...
\begin{tikzpicture}[scale=0.25]
  ...
  \node[xshift={25*-3.5},yshift={25*sqrt(3)*2.5}](0,0){$c_0=c_y^x$};
  \node[xshift={25*3.7},yshift={25*sqrt(3)*2.5}](0,0){$c_1=c_y^{x+n}$};
  \node[xshift={25*0.25},yshift={25*sqrt(3)*-0.2}](0,0){$c_2=c_{y+n}^x$};
\end{tikzpicture}
